...
public class MxPlayerActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (config == null || TextUtils.isEmpty(config.url)) {
            ...
            player.setScaleType(TextUtils.isEmpty(config.scaleType) ? MxPlayer.SCALETYPE_FITPARENT : config.scaleType);
    ...
    public static void play(Activity context, String... url) {
        Intent intent = new Intent(context, MxPlayerActivity.class);
    ...
    public static class Config implements Parcelable {
        ...
        public void play(String url) {
            this.url = url;
            Intent intent = new Intent(activity, MxPlayerActivity.class);
