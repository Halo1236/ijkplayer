...
public class MxPlayer {
    ...
    public MxPlayer(final Activity activity) {
        try {
            IjkMediaPlayer.loadLibrariesOnce(null);
            IjkMediaPlayer.native_profileBegin("libijkplayer.so");
            playerSupport=true;
        } catch (Throwable e) {
            Log.e("MxPlayer", "loadLibraries error", e);
        }
...
//                        Toaster.show("download rate:" + extra);
    ...
    /**
     * using constants in MxPlayer,eg: MxPlayer.SCALETYPE_FITPARENT
     * @param scaleType
     */
     ...
     */
    public MxPlayer seekTo(int msec, boolean showControlPanle){
    ...
    public MxPlayer forward(float percent) {
    ...
    public MxPlayer playInFullScreen(boolean fullScreen){
        if (fullScreen) {
            activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            updateFullScreenButton();
        }
    ...
    public MxPlayer onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public MxPlayer onComplete(Runnable complete) {
        this.oncomplete = complete;
        return this;
    }

    public MxPlayer onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public MxPlayer onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener){
     ...
     * @return
     */
    public MxPlayer live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }

    public MxPlayer toggleAspectRatio(){
        if (videoView != null) {
            videoView.toggleAspectRatio();
        }
        return this;
    ...
    public MxPlayer onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener){
        this.onControlPanelVisibilityChangeListener = listener;
        return this;
    }
}
